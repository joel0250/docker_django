...
SECRET_KEY = os.environ.get('SECRET_KEY', 'production-secret-key-change-this-in-prod')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'db_production'),
        'USER': os.environ.get('POSTGRES_USER', 'postgres_user'),
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'postgres_password_secure'),
...
# Email - use your production email settings
